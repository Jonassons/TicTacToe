...
public class MinMax {
	...
	public int minMax(TacTacLogic gameLogic, int depth, boolean isMaximizing) {
	...
	public int[] findBestMove(TacTacLogic gameLogic, boolean isMaximizing, int depth) {
